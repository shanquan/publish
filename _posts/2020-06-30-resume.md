...
- 学习HTML/CSS/JavaScript/jQuery EasyUI技术栈，作为唯一前端开发人员参与前后端分离的Java Web项目，为人事部门开发休假、考勤、绩效考核项目，开发周期1年，运行时间3～6年
  主要学习途径：W3School网站、jQuery手册、EasyUI官网
...
自学Ionic/Angular/Cordova技术，写了一个简单的个人休假管理APP，并分享给同事；之后承接事业部工厂的Android电视看板、IOS/Android跨平台智慧工厂数据中心的开发工作，并开始担任APP应用开发管理职位，指导新人开发Ionic类应用；
  ...
  4. 重构cardReader项目并制定ionic项目代码注释模板，使用JSDoc工具根据注释自动生成文档: [JSDoc:cardReader](https://devdata-1252923336.cos.ap-guangzhou.myqcloud.com/html/cardReaderDocs/index.html)
...
负责比亚迪试乘试驾企业号项目的调研及前端开发，通过在Vue官网阅读官方文档学习并使用Vue 3.0.5、Mint-UI、Element、vue-amap开发；
...
- 熟悉开发应用各种地图组件，并开发自定义轨迹播放（高德地图）组件
...
在`ionic-demos/TVTemplates`中有应用FusionCharts(svg)库、Chart(canvas)库、Charts(D3)库，手环APP项目中的睡眠、步数柱状、曲线图均直接使用canvas开发实现，未依赖第三方可视化库。
...
- 两个Bash Shell脚本应用：[export-wechat-voices](https://github.com/shanquan/export-wechat-voices)、[private:cordova-ci](https://github.com/shanquan/cordova-ci)
- Ubuntu\CentOS服务器使用和部署经验，部署应用包含：Samba,Subversion,Apache,Trac,webDav,Openldap
...
- 求职意向：web前端开发（高级/主管）、全栈开发，公司提供高速畅通网络环境更佳，无意于996
- 地点：深圳/远程
